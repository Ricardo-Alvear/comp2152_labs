...
# Load findings from CSV using DictReader
...
# Find the n most targeted subdomains
def top_subdomains(findings, n):
    # Use our previous function to get counts per subdomain
    counts = count_by_field(findings, "subdomain")
    # Sort the dictionary items by the value (count) in descending order
